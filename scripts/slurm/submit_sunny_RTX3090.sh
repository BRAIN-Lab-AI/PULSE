#!/bin/bash
#SBATCH --job-name=sunny_RTX3090
#SBATCH --output=/SLURM/home/slurm_g202518690/student251/CVPR/logs/sunny_RTX3090_%j.out
#SBATCH --error=/SLURM/home/slurm_g202518690/student251/CVPR/logs/sunny_RTX3090_%j.err
